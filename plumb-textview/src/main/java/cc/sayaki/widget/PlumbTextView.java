...
public class PlumbTextView extends View {
    ...
    public PlumbTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            } else if (attr == R.styleable.PlumbTextView_drawableEnd) {
                bitmapEnd = a.getDrawable(R.styleable.PlumbTextView_drawableEnd);
            }
        }
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bitmapEnd != null) {
            canvas.drawBitmap(((BitmapDrawable) bitmapEnd).getBitmap(), x - leftLinePadding, y + letterSpacing, drawablePaint);
        }
    }
    ...
    public void setDrawableEnd(int drawableEnd) {
        this.bitmapEnd = getResources().getDrawable(drawableEnd);
    }
